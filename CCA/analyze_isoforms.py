...
file_manifest = pandas.read_csv('/Users/ehrlich/Syncplicity/bioinformatics_folder/TCGI CHOL/TCGA CHOL RNA-seq/file_manifest.txt', sep='\t').shift(-2)
...
for i in subset_manifest.index:
    ...
    path1 = "/Users/ehrlich/Syncplicity/bioinformatics_folder/TCGI\ CHOL/TCGA\ CHOL\ RNA-seq/"
